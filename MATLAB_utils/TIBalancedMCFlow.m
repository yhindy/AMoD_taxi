function [cplex_out] = TIBalancedMCFlow(RoadGraph,RoadCap,TravelTimes,RebWeight,Sources,Sinks,FlowsIn,milpflag,congrelaxflag,sourcerelaxflag)
...
progressflag=1; 
cachedAeqflag=0;    % If true, does not compile Aeq and Beq but reads them
...
if cachedAeqflag
    ...
    save('CachedABeq','Aeqsparse','Beq','Aeqrow','Aeqentry','-v7.3')
